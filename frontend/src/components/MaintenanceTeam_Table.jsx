  ...
  if (sameSpec.length > 0) {
    const sequences = sameSpec
      .map((team) => {
        ...
        const numPart = teamId.startsWith(prefix)
    ...
    (async () => {
      try {
        ...
        const candidates = users.filter((u) => {
          const roleVal =
            u.role || u.role_name || u.position || u.roleId || u.role_id || "";
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <PopoverContent
                      className="z-[10001] w-[--radix-popover-trigger-width] rounded-xl border border-gray-200 bg-white p-3 shadow-xl"
                      align="start"
                    >
