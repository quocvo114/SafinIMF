...
function ConfidenceScoreWidget({ score, details }) {
  ...
  return (
    <div
      className={`flex items-center gap-3 rounded-xl border ${levelConfig.border} ${levelConfig.bg} px-3.5 py-2.5`}
    >
      <div
        className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full ${levelConfig.bg} ${levelConfig.color}`}
      >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {hasScore && (
            <span className={`text-base font-black ${levelConfig.color}`}>
              {score}%
            </span>
          )}
        </div>
